    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=""><i class="fa-solid fa-globe"></i> Trading and Markets</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=""><i class="fa-solid fa-briefcase"></i> Funds</h4>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=""><i class="fa-regular fa-address-book"></i> Console</h4>
